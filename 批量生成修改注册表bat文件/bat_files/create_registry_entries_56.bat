...
reg add "HKEY_CURRENT_USER\Software\Classes\Local Settings\Software\Microsoft\MSIPC\aip-addin" /v "RMSUser" /t REG_SZ /d "jean-liujing.wu@cn.abb.com" /f

REM Create UPN value under aip-addin node
reg add "HKEY_CURRENT_USER\Software\Classes\Local Settings\Software\Microsoft\MSIPC\aip-addin" /v "UPN" /t REG_SZ /d "jean-liujing.wu@cn.abb.com" /f
